...
bool LoadingScene::init()
{
    ...
    this->removeChildByTag(EM_LOADING_BOTTOM_LAYOUT);

    auto playout = Layout::create();

    playout->setTag(EM_LOADING_BOTTOM_LAYOUT);
...
void LoadingScene::onEnterTransitionDidFinish()
{
    ...
    auto playout = this->getChildByTag(EM_LOADING_BOTTOM_LAYOUT);
...
void LoadingScene::runFinish()
{
    ...
    auto playout = static_cast<Layout *>(this->getChildByTag(EM_LOADING_BOTTOM_LAYOUT));
