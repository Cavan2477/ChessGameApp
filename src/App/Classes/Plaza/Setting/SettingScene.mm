...
bool SettingScene::init()
{
    ...
    sliderSound->setTag(TAG_SliderSound);
    ...
    sliderMusic->setTag(TAG_SliderMusic);
...
void SettingScene::sliderCallBack(cocos2d::Ref *ref, cocos2d::ui::Slider::EventType type)
{
    ...
    if (slider->getTag() == TAG_SliderSound)
    {
    ...
    if (percent > 0)
    {
        ...
        auto quiet = static_cast<Button *>(rootNode->getChildByTag(TAG_Quiet));
        quiet->loadTextures("setting_res/set_sliper_close.png", "setting_res/set_sliper_open.png");
    }
}
