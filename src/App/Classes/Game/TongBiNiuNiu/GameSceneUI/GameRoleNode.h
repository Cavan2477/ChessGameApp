#ifndef __tbnn_header_GameRoleNode_H__
#define __tbnn_header_GameRoleNode_H__
...
public:
     ...
     * @param[str] 聊天内容
     */
    void textChat(const enGameChairIndex &dir,const char *str);
     ...
     * @param[idx] 表情索引
     */
    void browChat(const enGameChairIndex &dir, const int &idx);
    
    void changeChatPos(const enGameChairIndex &dir);
    
    void refreshScore(LONGLONG score);
...
private:
    ...
    std::string formatScore(LONGLONG score);
private:
	//背景
    ...
    //分数
    cocos2d::ui::TextAtlas *m_atlasScore;
