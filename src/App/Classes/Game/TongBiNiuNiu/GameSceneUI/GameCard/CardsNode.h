#ifndef __tbnn_header_CardsNode_H__
#define __tbnn_header_CardsNode_H__
...
public:
	 ...
	 * @return CardsNode
	 */
	static CardsNode* createCardsNode(const enGameChairIndex &dir, const tagCards &cards, bool isShowCard = false);
    ...
    //单个发牌
    void dispatchCardBySingle();
    
    //单个发牌结束
    void dispatchCardOver();
public:
	// 点击事件
...
public:
	 ...
	 * @param[isShowCard] 是否明牌
	 */
	void updateCardsNode(const enGameChairIndex &dir, const tagCards &cards, bool isShowCard = false);
    
    void arrangeCardsNodeWithUpdate(const enGameChairIndex &dir, const tagCards &cards, bool isShowCard, bool bAnimation);
	...
	void refreshLeftCards(const enGameChairIndex &dir,const BYTE &left);
    ...
    void showNiuNiuNode(bool bEnd = false);
private:
	void addCardsHolder();
