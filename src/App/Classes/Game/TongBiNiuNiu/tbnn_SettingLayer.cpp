...
bool SettingLayer::init()
{
    ...
    do
    {
        ...
        m_bInit = true;
        auto bg = m_root->getChildByName("setting_bg");
        CC_ASSERT(bg != nullptr);
        
        m_sliderEffect = static_cast<Slider*>(bg->getChildByName("effect_slider"));
        ...
        m_sliderMusic = static_cast<Slider*>(bg->getChildByName("music_slider"));
        ...
        */
        m_checkAllClose = static_cast<CheckBox*>(bg->getChildByName("allclose_check"));
        ...
        auto csbBtn = static_cast<Button*>(bg->getChildByName("close_btn"));
