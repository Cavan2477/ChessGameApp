...
typedef enum
{
	EM_GAME_LANDLOAR_ELEMENT = 20,		// 斗地主一方玩家最大牌
}ENUM_GAME_LANDLORD_ELEMENT;
...
}ENUM_DOWNLOAD_STATUS;

// 游戏下载进度
typedef struct _stDownloadRefresh
{
	ENUM_GAME   emGame;					// 游戏类型
...
{
	ENUM_GAME				emGame;				// 游戏类型
	ENUM_DOWNLOAD_STATUS	emDownloadStatus;	// 下载状态
