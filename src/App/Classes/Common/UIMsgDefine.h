...
typedef enum 
{
    EM_LOGIN_UI_REISTER_LAYER	= EM_UI_MSG::EM_UI_MSG_LOGIN + 1,						// 注册界面
...
typedef enum 
{
	EM_PLAZA_UI_ENTER_ROOM		= EM_UI_MSG::EM_UI_MSG_PLAZA + 1,						// 进入房间
...
typedef enum 
{
    EM_GAME_UI_EXIT_GAME       = EM_UI_MSG::EM_UI_MSG_GAME + 1,							// 退出游戏
...
typedef enum 
{
    EM_TASK_UI_TAKE_TASK       = EM_UI_MSG::EM_UI_MSG_TASK + 1,							// 领取任务
    EM_TASK_UI_TAKE_REWARD,                                                             // 领取奖励
}EM_TASK_UI;

typedef enum 
{
    EM_BANK_UI_OPEN_BANK		= EM_UI_MSG::EM_UI_MSG_BANK + 1,						// 开通银行
...
typedef enum 
{
    EM_CHECKIN_UI_GET_BASE_ENSURE= EM_UI_MSG::EM_UI_MSG_CHECKIN + 1,					// 领取低保
...
typedef enum 
{
    EM_PERSON_UI_CHANGE_LOGIN_PWD = EM_UI_MSG::EM_UI_MSG_PERSON + 1,					// 修改登陆密码
